...
public class PutWithJson {
    ...
    public void testUpdateBookingWithJSON() {
        ...
        File jsonPayload = new File("src/test/resources/updateBookingPayload.json");
        ...
        Assert.assertEquals(response.jsonPath().getString("firstname"), "Rose", "Firstname does not match!");
